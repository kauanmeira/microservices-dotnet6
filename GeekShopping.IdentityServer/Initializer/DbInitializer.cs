...
namespace GeekShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                UserName = "kauan-admin",
                Email = "kauanadmin@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (17) 98821-4036",
                FirstName = "Kauan",
                LastName = "Admin"
            };

            _user.CreateAsync(admin, "Kauan123$").GetAwaiter().GetResult();
            ...
            _user.CreateAsync(client, "Kauan123$").GetAwaiter().GetResult();
